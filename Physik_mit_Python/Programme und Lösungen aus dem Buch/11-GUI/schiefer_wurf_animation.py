...
class MainWindow(PyQt5.QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        # Initialisiere Attribute für das Simulationsergebnis.
        self.t = None
        self.r = None
        self.v = None
    ...
    def eingabe_float(self, field):
        """Lese eine Gleitkommazahl aus einem Textfeld aus. """
        try:
    ...
    def simulation(self):
        ...
        # Lese die Parameter aus den Eingabefeldern.

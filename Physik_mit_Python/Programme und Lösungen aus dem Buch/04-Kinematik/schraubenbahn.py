...
def update(n):
    ...
    punkt.set_data(r[n, 0],r[n, 1])
    punkt.set_3d_properties(r[n, 2])

    bahnani.set_data(r[0:n, 0],r[0:n, 1])
    bahnani.set_3d_properties(r[0:n, 2])
    return punkt, bahnani, arrow_v, arrow_a
